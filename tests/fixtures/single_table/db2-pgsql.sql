-- PostgreSQL: single_table fixture - database 2
...
CREATE TABLE test_table (
  ...
  description           TEXT,
  ignored_field         VARCHAR(100) DEFAULT 'this_change_should_be_ignored',
  another_ignored_field INT DEFAULT 777,
  important_field       VARCHAR(255) NOT NULL,
  new_important_field   VARCHAR(255) DEFAULT 'new_value'
);
