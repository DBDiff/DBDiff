...
CREATE TABLE `users` (
  ...
  `updated_at` timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,  -- Modified field
  PRIMARY KEY (`id`),
...
(2, 'Jane Smith', 'jane@example.com', '555-5678', 'pending'),  -- Different status
(4, 'Alice Brown', 'alice@example.com', '555-9999', 'active');  -- Different ID, Bob missing
