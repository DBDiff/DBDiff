<?php
 ...
 class End2EndTest extends PHPUnit\Framework\TestCase
 {
     ...
     protected function setUp(): void
     {
         ...
         // When DBDIFF_ENGINE is set (e.g., 'dolt'), use that as the suffix instead so
         // MySQL-compatible variants can have their own expected output files.
         ...
         if ($engine) {
             $this->migration_expected = $this->migration_expected . "_" . $engine;
             $this->migration_actual = $this->migration_actual . "_" . $engine;
         } else {
